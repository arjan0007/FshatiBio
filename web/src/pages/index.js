...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-b from-gray-50 to-white ${seasonalClass}`}>
      <Head>
        ...
        <section className="relative overflow-hidden rounded-b-3xl shadow-2xl">
          ...
          <div className="relative h-48 sm:h-56 md:h-64 lg:h-72 overflow-hidden rounded-b-3xl">
            {banners.map((banner, index) => {
              ...
              flashSaleEnd.setDate(flashSaleEnd.getDate() + 2); // 2 days from now
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-700 via-green-700 to-teal-700 text-white py-12 sm:py-16 lg:py-20">
        {/* Glow layers */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-10">
            ...
            <div className="text-center lg:text-left w-full lg:w-1/2 space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm text-sm sm:text-base">
                <span className="text-xl">{seasonalEmoji}</span>
                <span className="font-semibold">{seasonalGreeting}</span>
                <span className="text-white/70 text-xs sm:text-sm">• Sezoni i saborshëm</span>
              </div>
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black leading-tight">
                Produkte BIO <span className="text-amber-200 relative inline-block">
                  të Freskëta
                  <span className="absolute -bottom-2 left-0 w-full h-2 bg-amber-400/70 blur-sm rounded-full"></span>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                {['100% BIO të certifikuara','Dorëzim në 24h','Fermerë lokalë'].map((text, idx)=>(
                  <span
                    key={text}
                    className="px-4 py-2 rounded-full border border-white/30 bg-white/10 backdrop-blur-md text-sm flex items-center gap-2"
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
                <Link
                  ...
                  className="relative inline-flex items-center gap-3 bg-white text-emerald-700 px-6 py-3 rounded-full font-bold text-lg shadow-2xl hover:scale-105 transition-transform overflow-hidden group"
                >
                ...
                <Link
                  href="/about"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-white/40 text-white/90 hover:text-white hover:border-white transition"
                >
                  Mëso më shumë
            ...
            <div className="w-full lg:w-1/2">
              <div className="relative">
                <div className="absolute -top-8 -right-4 w-24 h-24 bg-white/10 rounded-full blur-3xl"></div>
                <div className="absolute bottom-0 left-0 w-32 h-32 bg-white/10 rounded-full blur-2xl"></div>

                <div className="relative bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[32px] p-6 shadow-[0_30px_80px_rgba(0,0,0,0.25)]">
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-white/70">Sezoni i</p>
                        <p className="text-2xl font-black text-amber-200">Vjeshtës së Ngrohtë</p>
                      </div>
      ...
      <section ref={categorySectionRef} className="relative py-16 sm:py-20 md:py-24 lg:py-28 overflow-hidden bg-white">
        <div className="container mx-auto px-4 relative z-10">
          {/* Header with Glow Effect */}
          <div className="text-center mb-12 md:mb-20 relative">
            <div className="inline-block mb-6 relative">
              <div className="absolute inset-0 bg-green-400 rounded-full blur-2xl opacity-50 animate-pulse"></div>
              <span className="relative text-6xl sm:text-7xl md:text-8xl animate-bounce block">✨</span>
            </div>
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 md:mb-6 relative inline-block">
            ...
            <p className="text-gray-700 text-lg sm:text-xl md:text-2xl px-4 font-semibold relative">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5 sm:gap-6 md:gap-8 lg:gap-10">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative h-full transform-style-preserve-3d transition-all duration-700 group-hover:rotate-y-12">
                      ...
                      <div className="relative h-full bg-white/80 backdrop-blur-xl p-6 sm:p-8 md:p-10 rounded-3xl shadow-2xl border-2 border-white/50 overflow-hidden transform translate-z-0 group-hover:translate-z-20 transition-all duration-700">
                        ...
                        <div className="relative z-10 text-center h-full flex flex-col items-center justify-center">
                          ...
                          <div className="relative mb-6 md:mb-8 transform group-hover:scale-125 group-hover:rotate-12 transition-all duration-700">
                            {/* Icon Background */}
                            <div className="relative inline-block p-5 md:p-7 bg-gradient-to-br from-white/90 to-white/60 backdrop-blur-md rounded-full shadow-2xl border-2 border-white/50 transition-all duration-500">
                              <span className="text-6xl sm:text-7xl md:text-8xl block transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-700 filter drop-shadow-2xl">
                          ...
                          <h3 className="font-black text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-800 group-hover:text-white transition-colors duration-500 relative mb-4 group-hover:neon-glow">
                          ...
                          <div className="mt-4 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                            <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-white/50">
                              <span className="text-green-600 text-xl font-bold transform group-hover:translate-x-2 transition-transform duration-300">→</span>
                              <span className="text-sm font-bold text-gray-700">Shiko</span>
                            </div>
                          </div>
                        </div>
      ...
      <section className="relative py-16 sm:py-20 md:py-24 lg:py-28 overflow-hidden bg-white">
        <div className="container mx-auto px-4 relative z-10">
          {/* Header with Glow Effect */}
          <div className="text-center mb-12 md:mb-20 relative">
            <div className="inline-block mb-6 relative">
              <div className="absolute inset-0 bg-green-400 rounded-full blur-2xl opacity-40 animate-pulse"></div>
              <span className="relative text-5xl sm:text-6xl md:text-7xl animate-bounce block">⭐</span>
            </div>
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-4 md:mb-6 relative inline-block">
              <span className="relative z-10 bg-gradient-to-r from-green-600 via-emerald-500 to-teal-600 bg-clip-text text-transparent animate-gradient-shift">
          ...
          <div className="text-center mt-12 md:mt-16 relative">
            <div className="inline-block relative">
              ...
              <Link
                href="/products"
                className="relative inline-flex items-center gap-3 bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white px-8 py-4 md:px-10 md:py-5 rounded-full font-black text-base md:text-lg lg:text-xl hover:from-green-700 hover:via-emerald-700 hover:to-teal-700 transition-all transform hover:scale-110 hover:shadow-2xl border-2 border-white/30 shadow-xl"
              >
                <span>Shiko Të Gjitha Produktet</span>
                <span className="text-xl md:text-2xl transform group-hover:translate-x-2 transition-transform duration-300">→</span>
              </Link>
            </div>
          </div>
        </div>
